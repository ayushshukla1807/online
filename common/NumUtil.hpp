...
/// When the state of indeed any failure details aren't needed, use strTo<T>.
...
/// Parse a string to unsigned 32-bit signed int.
/// Returns the parsed value and a boolean indicating success or failure.
...
/// Parse a string to signed 64-bit signed int.
/// Returns the parsed value and a boolean indicating success or failure.
...
/// Parse a string to unsigned 64-bit signed int.
/// Returns the parsed value and a boolean indicating success or failure.
